...
# Pre-defined configs
##
from isaaclab_assets import FRANKA_PANDA_HIGH_PD_CFG, UR10_CFG, UR10e_CFG  # isort:skip
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    if args_cli.robot == "ur10e":
        ee_goals = [
            [-0.3, 0.2, 0.7, 0.707, 0, 0.707, 0],
            [-0.3, -0.4, 0.7, 0.707, 0, 0.707, 0],
            [-0.3, -0.4, 0.2, 0.707, 0, 0.707, 0],
            [-0.3, 0.2, 0.2, 0.707, 0, 0.707, 0],
        ]
    else:
        ee_goals = [
    ...
    if args_cli.robot == "franka_panda":
        ...
        robot_entity_cfg = SceneEntityCfg("robot", joint_names=[".*_joint"], body_names=["wrist_3_link"])
    else:
        raise ValueError(f"Robot {args_cli.robot} is not supported. Valid: franka_panda, ur10, ur10e")
