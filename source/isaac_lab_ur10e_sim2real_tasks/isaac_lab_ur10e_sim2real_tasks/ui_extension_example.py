...
def some_public_function(x: int):
    print("[isaac_lab_ur10e_sim2real_tasks] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[isaac_lab_ur10e_sim2real_tasks] startup")
    ...
    def on_shutdown(self):
        print("[isaac_lab_ur10e_sim2real_tasks] shutdown")
