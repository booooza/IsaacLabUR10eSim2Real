...
URDF_UR10e_BASE_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "ur10e/ur10e_base.urdf"))
URDF_UR10e_HANDE_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "ur10e/ur10e_with_hande.urdf"))
...
UR10e_CFG_POSITION_CONTROL = UR10e_CFG.copy()
UR10e_CFG_POSITION_CONTROL.spawn.joint_drive.target_type = "position"
UR10e_CFG_POSITION_CONTROL.actuators = {
...
UR10e_HANDE_GRIPPER_CFG = UR10e_CFG_POSITION_CONTROL.copy()
UR10e_HANDE_GRIPPER_CFG.spawn.asset_path = URDF_UR10e_HANDE_PATH
UR10e_HANDE_GRIPPER_CFG.spawn.variants = {"Gripper": "Robotiq_HandE"}
UR10e_HANDE_GRIPPER_CFG.spawn.rigid_props.disable_gravity = True
UR10e_HANDE_GRIPPER_CFG.spawn.convert_mimic_joints_to_normal_joints = True

UR10e_HANDE_GRIPPER_CFG.actuators["gripper"] = ImplicitActuatorCfg(
    ...
    stiffness=150.0, # p-gain (tuned in gain tuner)
    damping=5.0, # d-gain (tuned in gain tuner)
    friction=0.1,
    armature=0.001,
)
UR10e_HANDE_GRIPPER_CFG.init_state.joint_pos["robotiq_hande_left_finger_joint"] = 0.025 # open position
UR10e_HANDE_GRIPPER_CFG.init_state.joint_pos["robotiq_hande_right_finger_joint"] = 0.025 # open position
